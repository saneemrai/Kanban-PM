...
All start scripts build the `pm-app` Docker image, replace any existing `pm-app` container, pass the project-root `.env` file to Docker, and publish the app at `http://127.0.0.1:8000`.
